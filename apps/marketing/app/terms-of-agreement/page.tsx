        ...
        <div className="flex flex-col gap-4 px-4 pb-48">
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              <span className="font-bold">&quot;our&quot;</span>). By accessing
              or using our software and services, you agree to be bound by these
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              read, understood, and agree to comply with these Terms of
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              This license is granted solely for your business use and is not
              for resale.
            </p>
            <p>You may not:</p>
          ...
          <div className="flex flex-col gap-2">
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                Avoid transmitting harmful or unlawful content, including
                malware, offensive material, or spam.
              </li>
              <li>
          ...
          <div className="flex flex-col gap-2">
            ...
            <ul className="list-disc list-inside">
              <li>
                You are responsible for ensuring that your customers&apos; data
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              To the fullest extent permitted by law, Mighty Bee is not liable
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              If a mutual agreement on location cannot be reached, the
              arbitration will default to virtual proceedings to ensure
              accessibility for both parties. Decisions rendered by the
              arbitrator are final and enforceable.
            </p>
          </div>
          <div className="flex flex-col gap-2">
            <p className="text-xl font-bold tracking-[0.03em]">
            ...
            <p>
              You agree to indemnify and hold harmless Mighty Bee, its

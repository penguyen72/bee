  ...
  return (
    <div className="flex flex-col h-full text-center">
      <div className="bg-[#FFF3D0] flex-1 flex flex-col gap-8 items-center justify-center p-12">
        <p className="mb-12 text-6xl font-extrabold">Welcome to Sun Nails & Spa!</p>
        <Button
      ...
      <div className="bg-[#FFF7EA] flex flex-col items-center justify-center p-12 gap-1">
        <p className="mb-2 text-3xl font-semibold">Check In and Earn Points for your Next Visits!</p>

...
import { Form, FormControl, FormDescription, FormField, FormItem, FormMessage } from '@bee/ui/components/ui/form';
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-2 w-full">
        ...
        <FormDescription className="text-black text-base mb-2">Please enter your basic information.</FormDescription>
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="w-full">
              <FormControl>
                <Input className="text-base" placeholder="First Name" {...field} />
              </FormControl>
            </FormItem>
          )}
        />

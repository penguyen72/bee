...
export function OverviewCard({ overview }: Props) {
  ...
  const currentDateBasedOnTimeZone = formatInTimeZone(Date.now(), overview.timezone, 'MM/dd/yyyy');

  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>Today&apos;s Overview - {currentDateBasedOnTimeZone}</CardTitle>
      </CardHeader>
